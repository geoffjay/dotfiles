...
// file exists, all it's contents will be replaced by the contents of the
// source file. The file mode will be copied from the source and the copied
// data is synced/flushed to stable storage.
...
// RemoveGlob gets a slice of the contents of the folder, then deletes
